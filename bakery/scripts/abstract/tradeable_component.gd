...
func initialize_seller_gui():
	...
	for prev_item_gui in seller_gui.inside_container.get_children():
		prev_item_gui.queue_free()
	...
	for item: String in get_parent().get_shop_items():
		...
		print("Seller debug > for ", get_parent().ID, " setting ", item)
...
func _on_click_to_trade_mouse_entered() -> void:
	print("Seller debug > mouse entered dollar")
...
func _on_click_to_trade_mouse_exited() -> void:
	print("Seller debug > mouse exited dollar")
...
func _input(event: InputEvent) -> void:
	if event.is_action_pressed("left_click") and mouse_is_hovering_dollar:
		print("Seller debug > left click registered")
		if not seller_gui_shown:
			seller_gui_shown = true
			print("Seller debug > showing gui")
			seller_gui.show()
		else:
