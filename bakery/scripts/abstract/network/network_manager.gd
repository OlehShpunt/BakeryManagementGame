...
const GAME_SCENE = "res://scenes/locations/street.tscn"
const MAIN_MENU_SCENE = "res://scenes/gui/start_menu.tscn"
...
var _available_networks: Dictionary = {
	0: {"scene":"res://scenes/network/enet_network.tscn", "menu":"res://scenes/gui/menus/enet_menu.tscn"},
	1: {"scene":"res://scenes/abstract/network/noray_network.tscn", "menu":"res://scenes/gui/menus/noray_menu.tscn"}
}
...
var _loading_scene = preload("res://scenes/abstract/network/loading_scene.tscn")
